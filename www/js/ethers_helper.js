...
const rewardsContract_stake = async function(stakingTokenAddr, rewardPoolAddr, App) {
        ...
        if ((currentTEND / 1e18) > 0) {
            ...
            allow.then(async function() {
                WEEBTEND_V2_TOKEN.stake(currentTEND, {gasLimit : 260000}).then(function(t) {
...
const rewardsContract_unstake = async function(rewardPoolAddr, App) {
    ...
    if (currentStakedAmount > 0) {
        showLoading();
        REWARD_POOL.withdraw(currentStakedAmount, {gasLimit: 260000})
            .then(function(t) {
                return App.provider.waitForTransaction(t.hash);
            }).catch(function() {
            hideLoading();
...
const rewardsContract_exit = async function(rewardPoolAddr, App) {
    ...
    if (currentStakedAmount > 0) {
        showLoading();
        REWARD_POOL.exit({gasLimit: 260000})
            .then(function(t) {
                return App.provider.waitForTransaction(t.hash);
            }).catch(function() {
            hideLoading();
...
const rewardsContract_claim = async function(rewardPoolAddr, App) {
    ...
    if (earnedYFFI > 0) {
        showLoading();
        WEEBTEND_V2_TOKEN.getReward({gasLimit: 260000})
            .then(function(t) {
                return App.provider.waitForTransaction(t.hash);
            }).catch(function() {
            hideLoading();
...
const rewardsContract_claim_LP = async function(rewardPoolAddr, App) {
    ...
    if (earnedLP > 0) {
        showLoading();
        WEEBTEND_V2_TOKEN.claim({gasLimit: 260000})
            .then(function(t) {
                return App.provider.waitForTransaction(t.hash);
            }).catch(function() {
            hideLoading();
...
const rewardsContract_harvest = async function(rewardPoolAddr, App) {
    ...
    if (earnedLP > 0) {
        showLoading();
        WEEBTEND_V2_TOKEN.harvest({gasLimit: 260000})
            .then(function(t) {
                return App.provider.waitForTransaction(t.hash);
            }).catch(function() {
            hideLoading();
